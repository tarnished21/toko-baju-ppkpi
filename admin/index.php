...
session_start();
include 'koneksi.php';
// jika user mengisi email dan mengisi password maka, 
// ambil nilai dari masing-masing inputan
if (isset($_POST['email']) and isset($_POST['password'])) {
    ...
    // echo "Selamat datang email :$email dan password : $password";
}
?>
<!DOCTYPE html>
<html lang="en">
